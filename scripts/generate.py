...
for verb in data:
    ...
    forms = [inf, pres, impf, auxiliary, pastParticiple, presParticiple, imperat, passeSimple, future, conditional, subjunctivePres, subjunctiveImpf]
    ...
    print("st.bind(11, \"{0}\");".format(forms[10]))
    print("st.bind(12, \"{0}\");\nst.exec();\nst.reset();\nst.clearBindings();\n".format(forms[11]))
